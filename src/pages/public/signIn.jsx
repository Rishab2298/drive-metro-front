...
import { TrendingUp, Shield, CheckCircle2, Sparkles, Users, Zap, ArrowLeft } from 'lucide-react';

const SignInPage = () => {
  const features = [
    { text: "Real-time analytics dashboard", icon: TrendingUp },
    { text: "AI-powered coaching insights", icon: Sparkles },
    { text: "One-click scorecard distribution", icon: Zap },
    { text: "50,000+ drivers managed", icon: Users },
  ];
  ...
  return (
    <div className="min-h-screen flex relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute top-0 left-1/4 w-[800px] h-[800px] rounded-full bg-linear-to-br from-indigo-600/20 to-transparent blur-[120px]" />
        <div className="absolute bottom-0 right-1/4 w-[600px] h-[600px] rounded-full bg-linear-to-br from-violet-600/15 to-transparent blur-[100px]" />
        <div
        ...
        <div>
          ...
          <div className="max-w-md">
            ...
            <p className="text-lg text-slate-400 mb-12 leading-relaxed">
              Sign in to access your DSP dashboard and continue driving
              <span className="text-indigo-400 font-medium"> performance excellence</span>.
            </p>

            {/* Features */}
            <div className="space-y-4">
              {features.map((feature, index) => (
                <div key={index} className="flex items-center gap-3 p-3 rounded-xl bg-white/[0.03] border border-white/[0.06] hover:bg-white/[0.05] hover:border-indigo-500/20 transition-all">
                  <div className="w-8 h-8 rounded-lg bg-linear-to-br from-indigo-500/20 to-violet-500/20 flex items-center justify-center">
